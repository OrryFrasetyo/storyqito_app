...
abstract class AppLocalizations {
  ...
  /// No description provided for @name_app.
  ///
  ...
  /// No description provided for @please_login_using_your_account.
  ///
  /// In id, this message translates to:
  ...
  ///
  /// In id, this message translates to:
  /// **'Gagal masuk akun. Silahkan coba kembali.'**
  ...
  /// No description provided for @story_detail.
  ///
  /// In id, this message translates to:
  /// **'Detail Cerita'**
  String get story_detail;
  ...
  /// No description provided for @please_write_description.
  ///
  /// In id, this message translates to:
  /// **'Mohon isi deskripsi terlebih dahulu'**
  String get please_write_description;
  ...
  /// No description provided for @question_mark.
  ///
  /// In id, this message translates to:
  /// **'?'**
