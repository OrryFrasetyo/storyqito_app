...
This guide will help you set up your Storyqito project for local development.
...
```bash
git clone https://github.com/OrryFrasetyo/storyqito_app.git
cd storyqito_app
...
Install and use the required Flutter version `3.32.8` via FVM:
...
you can view the results [here](https://github.com/...).
...
- **Free**: Users can't attach location when posting stories
